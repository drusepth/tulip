module PoisHelper
  ...
  def category_icon(category, size: nil)
    ...
    when 'stations'
      '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7v8a2 2 0 002 2h4a2 2 0 002-2V7m-8 0V5a2 2 0 012-2h4a2 2 0 012 2v2m-8 0h8M6 21h12M9 17v4m6-4v4"></path>'
    else
